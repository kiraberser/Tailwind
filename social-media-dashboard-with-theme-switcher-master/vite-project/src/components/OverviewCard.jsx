...
export const OverviewCard = ({user, audienceType, audience, network, isUp, today}) => {
    ...
    return (
        <article className="bg-Light-Grayish-Blue w-[326px] h-[216px] mb-4 rounded-[5px] text-center mx-auto overflow-hidden dark:bg-Dark-Desaturated-Blue hover:brightness-95 cursor-pointer hover:dark:brightness-125">
            <div className={`${networkColors[network]} h-[3px] mb-8`}></div>
